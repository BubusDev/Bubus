...
export function HomeInstagramPromo({ block }: HomeInstagramPromoProps) {
  ...
  return (
    <section className="bg-[#eef3e9] py-10">
      <a
        ...
        className="group mx-auto grid w-full max-w-[1500px] overflow-hidden bg-[#eef3e9] transition md:grid-cols-[0.95fr_1.05fr]"
      >
        ...
        <div className="flex min-h-[320px] flex-col justify-center px-6 py-10 sm:px-10 lg:px-16">
