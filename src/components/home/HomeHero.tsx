  ...
  return (
    <section className="bg-[#fbfaf7] pt-5">
      <Link
        ...
        className="group relative block min-h-[480px] w-full overflow-hidden bg-[#e7e5df] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7b8566] focus-visible:ring-offset-4 sm:min-h-[520px]"
      >
        <Image
          src={block.imageUrl}
          alt={block.imageAlt}
        ...
        <div className="relative mx-auto flex min-h-[480px] max-w-[1500px] items-end px-6 py-8 sm:min-h-[520px] sm:px-10 sm:py-10 lg:px-16 lg:py-14">
          <div className="max-w-[560px] text-white">
            ...
            {block.title ? (
              <h1 className="font-[family:var(--font-display)] text-[2.25rem] leading-[0.98] tracking-[-0.03em] sm:text-[3.1rem] lg:text-[4.2rem] xl:text-[4.6rem]">
                {block.title}
              </h1>
            ) : null}
            {block.body ? (
