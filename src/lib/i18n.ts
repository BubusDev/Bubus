...
const en: Dictionary = {
  ...
  "homepage.editorialEyebrow": "THE CHICKS PERSPECTIVE",
  "homepage.editorialTitle": "Not mass-made. Made with character.",
  "homepage.editorialLead": "Our collections do not start from seasonal noise, but from stones, tones and wearable details. We create jewelry that does not ask for attention, yet stays with you.",
  "homepage.editorialFirstNote": "Our pieces are made in small quantities, so favourite combinations are often available only for a short time.",
  "homepage.editorialSecondNote": "The goal is a delicate, personal jewelry wardrobe: layerable, easy to wear, never loud, yet full of memorable details.",
  "homepage.editorialCta": "DISCOVER THE GEMSTONES",
